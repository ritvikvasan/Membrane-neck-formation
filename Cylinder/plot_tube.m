...
subplot(1,3,1)
pointsize = 10;
scatter(Sol(1,:)*R0, -Sol(2,:)*R0, pointsize, Sol(4,:)/R0);%plot(Sol(1,:)*R0, Sol(2,:)*R0,'Color', memColor, 'LineWidth', lineWidth);
hold on
scatter(Sol(1,:)*R0, Sol(2,:)*R0, pointsize, Sol(4,:)/R0);
colorbar
h = colorbar;
...
hold on
scatter(Sol(1,:)*R0, -Sol(2,:)*R0, pointsize, Sol(6,:)*k0/R0^2);
colorbar
h = colorbar;
